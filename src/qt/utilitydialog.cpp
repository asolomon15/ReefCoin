    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Proton Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Proton Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  reef-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Proton in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an reeftive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 REEF, 0.1 REEF, 1 REEF and 10 REEF -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://reefcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://reefcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Proton Core is shutting down...") + "<br /><br />" +
