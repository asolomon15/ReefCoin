    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Reef Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Reef Core"));
...
All the Reef in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Reef Core is shutting down...") + "<br /><br />" +
