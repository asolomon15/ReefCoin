    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Reef Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Reef address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reef: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Reef Core"), this);
    aboutAction->setStatusTip(tr("Show information about Reef Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Reef Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Reef addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Reef addresses"));
    ...
    openAction->setStatusTip(tr("Open a reef: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Reef Core help message to get a list with possible Reef Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Reef Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Reef network", "", count));
}
...
{
    QString strTitle = tr("Reef Core"); // default title
