...
====================================
This guide will show you how to build reefd (headless client) for OSX.
...
4.  (Optional) You can also install reefd to your path:
...
4. Enter "reef-qt" as project name, enter src/qt as location
...
It's now available at `./reefd`, provided that you are still in the `src`
...
-------
    ...
    ./reefd -daemon # to start the reef daemon.
    ./reef-cli --help  # for a list of command-line options.
    ./reef-cli help    # When the daemon is running, to get a list of RPC commands
