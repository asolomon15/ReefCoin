...
Notes
-----
The release is built with GCC and then "strip reefd" to strip the debug
...
# Configure Proton Core to use our own-built instance of BDB
cd $REEF_ROOT
./autogen.sh
...
Security
--------
To help make your Proton installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Proton Core should be built with a non-executable stack
